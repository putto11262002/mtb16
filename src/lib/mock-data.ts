export const announcements = [
  {
    ...
    content:
      'We are pleased to announce the formation of a new specialized unit focusing on cyber defense. This unit will be operational starting next month.',
  ...
  },
  {
    ...
    content:
      'The annual physical fitness test for all personnel will be held from September 1st to September 5th. Please check with your unit leaders for specific schedules.',
  ...
  },
  {
    ...
    content:
      'Updated safety regulations regarding equipment handling have been issued. All personnel are required to review the new guidelines.',
