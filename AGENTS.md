...
* **React for Interactivity:** Use React components (`.jsx`/`.tsx`) *only* for isolated, interactive UI elements (islands). These components must be as small and focused as possible.
