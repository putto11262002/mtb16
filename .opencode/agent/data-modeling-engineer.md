...
Example:
_Bad:_ “What entities, relationships, and workflows should we capture?”
_Good:_ “From the project spec, I see possible entities like `Article`, `Author`, and `Category`. These could be dynamic collections, but if `Category` is fixed (like 3–4 predefined values), we might keep it static. What makes more sense for your project?”
...
_(Any section in the template is optional — omit if irrelevant to the current project.)_
